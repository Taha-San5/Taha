...
export const TEMPLATES: TemplateSeed[] = [
  {
    slug: "page-summary",
    name: "Summarise any page",
    nameAr: "لخّص أي صفحة",
    description: "Give it a URL, get a clean bullet summary in the page's own language.",
    descriptionAr: "أعطه رابطاً لتحصل على ملخص منظم في نقاط بلغة الصفحة نفسها.",
    category: "research",
    emoji: "FileSearch",
    featured: true,
    installs: 1284,
  ...
  },
  {
    ...
    graph: graph(
      [
        ...
        n("brief", "ai.ask", 5, 0, {
          prompt: "In one sentence, explain why this headline matters to a technical team:\n\n{{$item}}",
          temperature: 0.3,
          maxTokens: 160,
        }),
        n("join", "data.join", 6, 0, { separator: "numbered" }),
        n("compose", "data.template", 7, 0, {
          template: "*Today's digest*\n\n{{$input}}\n\n_Generated by Wasl_",
        }),
